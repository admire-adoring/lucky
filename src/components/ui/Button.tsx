...
const VARIANTS: Record<Variant, string> = {
  ...
  primary:
    'bg-[linear-gradient(180deg,rgba(32,36,48,.95)_0%,rgba(12,14,20,.97)_100%)] text-white shadow-[0_6px_18px_rgba(16,18,24,.22),inset_0_1px_0_rgba(255,255,255,.18)] hover:-translate-y-px hover:bg-[linear-gradient(180deg,rgba(44,49,64,.96)_0%,rgba(16,18,24,.98)_100%)] hover:shadow-[0_14px_30px_rgba(16,18,24,.3),inset_0_1px_0_rgba(255,255,255,.22)]',
