#!/usr/bin/env node
/* ============================================================================
   由 DESIGN_TOKENS.md §2.7 的设计原值反解「派生色」
   ----------------------------------------------------------------------------
   规范只给了两样原值：① 强调色 --s-<模块>（RGB 三元组）② 亮色色团 --a-<模块>-1/2/3（hex）。
   其余六支必须**反解**，不能手估：
...
/* ---------- 设计原值：DESIGN_TOKENS.md §2.7 逐字照抄 ---------- */
const MODULES = [
  { key: 'dashboard', name: '微光夜语', s: [78, 135, 235], ring: ['#EED0F2', '#9EBAEB', '#96DFF5'], dk: [[44, 25, 46], [15, 41, 86], [12, 88, 112]] },
  { key: 'tasks', name: '薄荷蜜语', s: [250, 59, 138], ring: ['#DEFAF3', '#B8F6E7', '#F9A7C9'], dk: [[27, 44, 40], [22, 79, 65], [105, 19, 54]] },
  { key: 'calendar', name: '霜薄甜语', s: [203, 83, 251], ring: ['#FCF4E7', '#C8F2F7', '#F0CFFD'], dk: [[42, 37, 29], [29, 68, 72], [72, 38, 86]] },
  { key: 'life', name: '霜薄甜语·紫', s: [4, 163, 36], ring: ['#F2E8F4', '#CDFAD6', '#EAB9F8'], dk: [[40, 30, 41], [30, 71, 38], [80, 29, 95]] },
  { key: 'work', name: '星云微光', s: [248, 6, 230], ring: ['#F6E9F1', '#F77FEE', '#AFA8F1'], dk: [[41, 30, 37], [98, 3, 91], [31, 23, 100]] },
  { key: 'learning', name: '绿色糖果', s: [78, 158, 4], ring: ['#DEFAF3', '#B8F67E', '#F9A7C9'], dk: [[27, 44, 40], [49, 98, 3], [105, 19, 54]] },
  { key: 'projects', name: '浅紫蓝', s: [63, 150, 168], ring: ['#E8F2F4', '#9DBCFB', '#F7B3D6'], dk: [[30, 40, 41], [7, 36, 94], [97, 26, 63]] },
  { key: 'knowledge', name: '柔雾蜜桃', s: [250, 75, 73], ring: ['#F2F1F6', '#FBB8B6', '#FC9291'], dk: [[32, 30, 41], [82, 21, 19], [118, 7, 6]] },
  { key: 'settings', name: '星云幻境', s: [26, 155, 124], ring: ['#DDF6F0', '#AAFCF2', '#D06EF6'], dk: [[28, 43, 40], [13, 88, 79], [87, 4, 120]] },
]
